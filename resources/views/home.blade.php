...
@section('content')
  <h1 class="text-3xl text-purple-500">Tableau de bord</h1>
  <div class="flex flex-col md:flex-row">
  <section class="text-purple-700 w-full w-1/3 mr-5">
  <h2 class="text-xl my-2"><svg class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="mb-3 {{ $proposal->validated ? 'text-purple-400' : '' }}">
  ...
  <section class="text-sm text-purple-700 w-full w-1/3 mr-5">
  <h2 class="text-xl my-2"><svg class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <section class="text-sm text-purple-700 w-full">
    ...
    <div class="mb-3">
      ...
      <span class="bg-white border border-purple-500 text-xs p-1 my-2 inline-block text-purple-500 rounded">Déjà validé</span>
      @else
      <a href="{{ route('confirm.proposal', [$proposal->id])}}" class="bg-purple-500 text-xs py-2 px-2 mt-2 mb-3 inline-block text-white hover:bg-purple-200 hover:text-purple-500 duration-200 transition rounded">Valider la proposition</a>
      @endif
      @endforeach
      </ul>
    </div>
