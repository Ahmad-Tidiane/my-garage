...
@section('content')
<h1 class="text-3xl text-gray-900 mb-6 text-center">Remplissez les informations</h1>
<form method="POST" action="{{ route('register') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    ...
    <button type="submit" class="bg-gray-500 text-white hover:bg-gray-700 transition ease-in-out duration-500 rounded-md shadow-md w-full block px-4 py-2 mt-3">Créer mon compte</button>
</form>
@endsection
